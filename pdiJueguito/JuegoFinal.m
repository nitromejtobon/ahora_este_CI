...
snapshot = getsnapshot(vid);%Capturamos la imagen de la c�mara
cdt = flip(snapshot,2);%Aplicamos la funci�n flip, que nos permite rotar la imagen y as� evitar el efecto de espejo
